...
public abstract class PipeliningServerHandler {
	...
	@Weave
	private static class ChunkedOutboundHandler {
		
		@Trace
		void writeSome() {
			NewRelic.getAgent().getTracedMethod().setMetricName("Custom","Micronaut","HTTP","Netty","OutboundHander","ChunkedOutboundHandler","writeSome");
			Weaver.callOriginal();
		}
	}
	...
	@Weave
	 public static class OutboundAccess {
